...
module adaptive_wavelet_accelerator #(
    ...
    // Status / Metrics
    output wire        precision_mode,   // Current: 0=8bit, 1=16bit
    output wire [31:0] current_energy,   // Signal energy (debug)
    output wire [31:0] total_cycles,     // Processing cycles
    output wire [31:0] cycles_8bit,      // Cycles if 8-bit mode
    output wire [31:0] cycles_16bit,     // Cycles if 16-bit mode
    output reg  [15:0] precision_switches // Number of mode changes
);
